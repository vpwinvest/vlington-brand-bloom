        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              A VLINGTON Properties dedica-se ao desenvolvimento de projetos imobiliários de
            ...
            <div className="flex gap-12">
              ...
              <div>
                ...
                <p className="text-xs tracking-widest uppercase text-muted-foreground mt-1">Projetos entregues</p>
              </div>
              <div>
