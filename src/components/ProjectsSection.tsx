...
const projects: Project[] = [
  ...
  },
  {
    ...
    gallery: [bridgeHouse3, bridgeHouse1, bridgeHouse2, bridgeHouse4, bridgeHouse5, bridgeHouse6, bridgeHouse7, bridgeHouse8, bridgeHouse9, bridgeHouse10, bridgeHouse11, bridgeHouse12, bridgeHouse13, bridgeHouse14, bridgeHouse15],
    features: [
